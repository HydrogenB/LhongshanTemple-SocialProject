...
export const translations = {
  en: {
    ...
    hero: {
      ...
      monthsLabel: 'months',
      daysLabel: 'days',
      foundingDate: 'Founded on the 18th day of the 5th month, 3rd year of Qianlong (May 18, 1738)',
  ...
  zh: {
    ...
    hero: {
      ...
      monthsLabel: '個月',
      daysLabel: '天',
      foundingDate: '初建於乾隆三年五月十八日（西元1738年5月18日）',
  ...
  th: {
    ...
    hero: {
      ...
      monthsLabel: 'เดือน',
      daysLabel: 'วัน',
      foundingDate: 'เริ่มสร้างวันที่ 18 เดือน 5 ปีเฉียนหลงที่ 3 (18 พฤษภาคม ค.ศ. 1738)',
  ...
  ja: {
    ...
    hero: {
      ...
      monthsLabel: 'ヶ月',
      daysLabel: '日',
      foundingDate: '乾隆3年5月18日創建（西暦1738年5月18日）',
  ...
  ko: {
    ...
    hero: {
      ...
      monthsLabel: '개월',
      daysLabel: '일',
      foundingDate: '건륭 3년 5월 18일 창건 (서기 1738년 5월 18일)',
